...
/* package CC-delcont-0.2 */
#define VERSION_CC_delcont "0.2"
#define MIN_VERSION_CC_delcont(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
...
/* package probability-0.2.4 */
#define VERSION_probability "0.2.4"
